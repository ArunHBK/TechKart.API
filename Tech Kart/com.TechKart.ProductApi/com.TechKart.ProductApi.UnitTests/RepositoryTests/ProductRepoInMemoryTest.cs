    ...
    public class ProductRepoInMemoryTest
    {
        ...
        private void SeedDatabase()
        {
            ...
            var productDetails = new List<ProductDetail>()
            {
                new ProductDetail()
                {
                    ProductId=1, Name = "boAt Airdopes 141", Brand="boAt", Category="Tws", Description="Earbuds with 42H playtime,IPX4 Water Resistance",Price=899
                },
                new ProductDetail()
                {
                    ProductId=2, Name = "Samsung S20 FE", Brand="Samsung", Category="SmartPhone", Description="8GB RAM, 128 GB Storage,Android 11",Price=29999
                },
                new ProductDetail()
                {
                    ProductId=3, Name = "boAt BassHeads 100", Brand="boAt", Category="Wired Earphones", Description="In Ear wired earphones with Mic",Price=299
                },
                new ProductDetail()
                {
                    ProductId=4, Name = "Oneplus 10 pro", Brand="Oneplus", Category="SmartPhone", Description="12GB RAM,256 GB Storage, Android 12",Price=64999
                }
            };
        ...
        //    mock.Setup(p => p.ViewProductDetails())
