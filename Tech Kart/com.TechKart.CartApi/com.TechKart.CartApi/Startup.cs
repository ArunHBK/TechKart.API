...
namespace com.TechKart.CartApi
{
   ...
   .AddJwtBearer(x =>
   {
       x.TokenValidationParameters = new TokenValidationParameters
       {
           ...
           ValidateLifetime = true
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "com.TechKart.CartApi", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "com.TechKart.CartApi v1"));
            }
